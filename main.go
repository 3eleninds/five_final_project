...
func (t Training) meanSpeed() float64 {
	// Формула расчета:
	//преодолённая дистанция за тренировку в км / время тренировки в часах
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((float64(CaloriesMeanSpeedMultiplier)*r.meanSpeed() + float64(CaloriesMeanSpeedShift)) * r.Weight / float64(MInKm) * float64(r.Duration.Hours()) * MinInHours)
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infoMessage := InfoMessage{TrainingType: r.TrainingType, Duration: r.Duration, Distance: r.distance(), Speed: r.meanSpeed(), Calories: r.Calories()}
	return infoMessage
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speed, 2)/(w.Height/float64(CmInM)))*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()) * float64(MinInHours))
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infoMessage := InfoMessage{TrainingType: w.TrainingType, Duration: w.Duration, Distance: w.distance(), Speed: w.meanSpeed(), Calories: w.Calories()}
	return infoMessage
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infoMessage := InfoMessage{TrainingType: s.TrainingType, Duration: s.Duration, Distance: s.distance(), Speed: s.meanSpeed(), Calories: s.Calories()}
	return infoMessage
}
